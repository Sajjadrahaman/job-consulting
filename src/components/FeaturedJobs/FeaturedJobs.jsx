    ...
    return (
        ...
        <div className='my-20'>
            ...
            <div className='flex justify-center'>
                {
                    !showAll && (<button onClick={() => setShowAll(true)} className='my-10 bg-violet-500 hover:bg-violet-800 py-2 px-5 rounded-md text-white font-semibold'>See All Jobs</button>)
                }
            </div>
        </div>
    );
