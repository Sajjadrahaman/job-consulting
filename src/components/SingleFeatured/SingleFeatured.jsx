    ...
    return (
        <div className='p-5 rounded-md border-2  '>
            ...
            <div className=''>
                ...
                <p className='text-sm mt-2 font-semibold'>{company_name}</p>
                <div className='flex gap-3 py-4'>
                    <p className='text-violet-500 border border-1 border-violet-500 px-3 py-1'>{fulltime_or_parttime}</p>
                    <p className='text-violet-500 border border-1 border-violet-500 px-3 py-1'>{remote_or_onsite}</p>
                </div>
                ...
                <button onClick={() => navigate(`/featuredDetails/${id}`)} className='bg-violet-500 hover:bg-violet-800 px-3 py-2 font-semibold text-white rounded-md '>View Details</button>
            </div>
        </div>
    );
};
